    ...
    if(candidato.length > 0) {
        ...
        for (let i in candidato.fotos){
            if (candidato.fotos[i].small === true){
                fotosHtml += `<div class="d1-image small"><img src="images/${candidato.fotos[i].url}" alt="">Vice-Prefeito</div>`
            } else{
                fotosHtml += `<div class="d1-image"><img src="images/${candidato.fotos[i].url}" alt="">Vice-Prefeito</div>`
            }
        }
